...
import org.rmj.cas.parameter.agent.*;
import org.json.simple.JSONObject;
import org.rmj.appdriver.constants.EditMode;
import org.rmj.appdriver.GRider;
import org.rmj.appdriver.iface.XMRecord;
import org.rmj.appdriver.agentfx.ui.showFXDialog;
import org.rmj.cas.parameter.base.Card;
import org.rmj.cas.parameter.pojo.UnitCard;

public class XMCard implements XMRecord{
    public XMCard(GRider foGRider, String fsBranchCD, boolean fbWithParent){
    ...
    public boolean browseRecord(String fsValue, boolean fbByCode){        
        JSONObject loJSON = searchCard(fsValue, fbByCode);
        
        if(loJSON == null)
            return false;
        else
            return openRecord((String) loJSON.get("sCardIDxx"));
    }
    
    public JSONObject searchCard(String fsValue, boolean fbByCode){
        String lsHeader = "Code»Name";
        String lsColName = "sCardIDxx»sCardName";
        String lsColCrit = "sCardIDxx»sCardName";
        String lsSQL = "SELECT " +
                            "  sCardIDxx" +
                            ", sCardName" + 
                            ", cRecdStat" + 
    ...
    private Card poControl;
    private UnitCard poData;
    ...
    private final String pxeModuleName = "XMCard";
}
